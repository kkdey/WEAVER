...
void train_biword2vec(char *train_file0, char *output_file0_left, char *output_file0_right, char *output_file0_out, 
					              char *binary0, char *dims0, char *threads,
                   	    char *window0, char *cbow0, char *min_count0, char *iter0, 
                        char *neg_samples0)
{
	  int i;
...
void biword2vec_wrap(char **train_file, char **output_file_left, char **output_file_right, char **output_file_out, 
					 char **binary, char **dims, char **threads,
                     char **window, char **cbow, char **min_count, char **iter, char **neg_samples)
{
    train_biword2vec(*train_file, *output_file_left, *output_file_right, *output_file_out, *binary, *dims, *threads,
